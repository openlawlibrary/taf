...
def attach_to_group(group):
    ...
    def update_expiration_date(path, role, interval, keystore, key, scheme, start_date, commit):
        """
        ...
        """
        developer_tool.update_metadata_expiration_date(path, role, interval, keystore, key,
