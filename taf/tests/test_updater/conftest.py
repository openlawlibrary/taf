...
FORCED_UPATE_PATTERN = r"Update of (\w+\/\w+) failed due to error: Repository ([\w/-]+)/(\w+) has uncommitted changes. Commit and push or revert the changes and run the command again."
