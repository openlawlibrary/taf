...
@pytest.mark.parametrize(
    ...
    [
        ...
        {
            "targets_config": [{"name": "target1"}, {"name": "target2", "allow_unauthenticated_commits": True}],
            "update_instructions": [
        ...
        },
        {
            ...
            "targets_config": [{"name": "target1"}, {"name": "target2"}],
            "update_instructions": [
                {"action": "update_expiration_dates", "params": {"datea": "2021-01-01"}},
            ]
        },
        {
            "targets_config": [{"name": "target1"}, {"name": "target2"}],
            "update_instructions": [
                {"action": "create_new_target_orphan_branches", "params": {"branch_name": "branch1"}},
                {"action": "add_valid_target_commits"},
            ]
        },
        {
